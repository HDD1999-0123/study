        ...
        <table height="100%" cellspacing=0 cellpadding=0 width=170   background=./img/menu_bg.jpg border=0>
            <tr>
                <td valign=top align=middle>
                    ...
                    <c:forEach items="${loginUser.role.menuList}" var="u1">
					<table cellspacing=0 cellpadding=0 width=150 border=0>
                        <tr height=22>
                            <td style="padding-left: 30px" background=./img/menu_bt.jpg>
							   <a     class=menuparent onclick=expand(${u1.menuId})    href="javascript:void(0);">${u1.menuName}</a>
							 </td>
						</tr>
                        <tr height=4>
                            <td></td>
					...
					<table id=child${u1.menuId} style="display: none" cellspacing=0 cellpadding=0  width=150 border=0>
                        <c:forEach items="${u1.secondMenuList}" var="m2">
						<tr height=20>
