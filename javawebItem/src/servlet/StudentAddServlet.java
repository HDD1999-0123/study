 ...
 * @author: hedd
 */
@WebServlet(urlPatterns = "/Educational/student/add")
public class StudentAddServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int result = studentListService.add(student);
        if (result > 0){
            req.getRequestDispatcher("studentList?pageIndex=1").forward(req,resp);
        }
    }
}
